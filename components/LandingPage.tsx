...
const LandingPage = () => {
  return (
    ...
    style={{ borderImage: 'linear-gradient(to bottom, rgba(0, 0, 0, 0.5), transparent) 1 100%'}}>
      <div className='px-12 mt-20 grid md:grid-cols-[2fr_1fr] gap-4 mb-4'> 
        ...
        <div className='md:h-[30rem] h-[13rem] rounded-3xl p-8 bg-cover transition-all duration-500 bg-no-repeat bg-center shadow-2xl' 
